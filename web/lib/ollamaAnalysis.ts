...
function buildAnalysisPrompt(input: ComplyzeAnalysisInput): string {
    const lines: string[] = [
        ...
        "- If sensitive data is found, ensure 'overall_risk_score' is above 60.",
        "- Ensure 'severity' matches the definitions above.",
        "- Provide clear 'findings' with 'evidence' (the specific toxic substring) and 'reason'.",
        "- Ensure 'suggested_action' is 'block' if the risk is HIGH or CRITICAL.",
