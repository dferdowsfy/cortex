        ...
        try {
            ...
            if (proxyRes.ok) {
                ...
                if (data.events) {
                    ...
                    // Derive unique protected browser instances from extension activity
                    const uniqueExtensions = new Set(data.events.map((e: any) => e.user_hash)).size;
                    setBrowsersProtected(uniqueExtensions);
                }
            }
            if (agentRes.ok && browsersProtected === 0) {
